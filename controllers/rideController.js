...
export const book = async (req, res, next) => {
    try {
      ...
      const { phone , startLocation, endLocation, startAddress, endAddress, scheduleTime, customerId, distance  } = req.body;

      if ( !startLocation || !endLocation || !startAddress || !endAddress || !distance) {
      ...
      //  `)
        ...
        return res.success({  msg: "schedule successfully", data: booking}, StatusCodes.CREATED, ReasonPhrases.CREATED);
  ...
  export const cancel = async (req, res, next) => {
    try {
      ...
      const { rideId  } = req.body;
        ...
        return res.success({  msg: "cancel successfully", data: {result: true}}, StatusCodes.OK, ReasonPhrases.OK);
  ...
  export const accept = async (req, res, next) => {
    try {
      ...
      const { rideId , driverId  } = req.body;
        ...
        return res.success({  msg: "accept successfully", data: {result: true}}, StatusCodes.OK, ReasonPhrases.OK);
  ...
  export const complete = async (req, res, next) => {
    try {
      ...
      const { rideId  } = req.body;
        ...
        return res.success({  msg: "completed ", data: {result: true}}, StatusCodes.OK, ReasonPhrases.OK);
  ...
  export const getCurrentRides = async (req, res, next) => {
    try {
      ...
      if (!customerId && !driverId) {
        ...
        return res.success({  msg: "retrieve successfully", data: currentRides}, StatusCodes.OK, ReasonPhrases.OK);
  ...
  export const getHistories = async (req, res, next) => {
    try {
      ...
      if (!customerId && !driverId) {
        ...
        return res.success({  msg: "retrieve successfully", data: histories}, StatusCodes.OK, ReasonPhrases.OK);
